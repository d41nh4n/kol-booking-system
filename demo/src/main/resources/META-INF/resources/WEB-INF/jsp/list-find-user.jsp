                  ...
                  <div class="col-lg-3">
                    <div>
                      <a class="btn btn-primary" href="#"
                        ><i class="uil uil-filter"></i> Filter</a
                      ><a class="btn btn-success ms-2" href="#"
                        ><i class="uil uil-cog"></i> Advance</a
                      >
                    </div>
                  </div>
                </div>
                      ...
                      <div class="candidate-list-content mt-3 mt-lg-0">
                        ...
                        <ul class="list-inline mb-0 text-muted">
                          <li class="list-inline-item">
                            <i class="mdi mdi-map-marker"></i> Oakridge Lane
                            Richardson
                          </li>
                          <li class="list-inline-item">
                ...
                <div class="p-4 card-body">
                  <div class="align-items-center row">
                    ...
                    <div class="col-lg-5">
                      <div class="candidate-list-content mt-3 mt-lg-0">
                        <h5 class="fs-19 mb-0">
                          <a class="primary-link" href="#">Gabriel Palmer</a
                          ><span class="badge bg-warning ms-1"
                            ><i class="mdi mdi-star align-middle"></i>3.4</span
                          >
                        </h5>
                    ...
                    <div class="col-lg-5">
                      <div class="candidate-list-content mt-3 mt-lg-0">
                        <h5 class="fs-19 mb-0">
                          ...
                          ><span class="badge bg-success ms-1"
                            ><i class="mdi mdi-star align-middle"></i>4.3</span
                          >
                        </h5>
                        ...
                        <ul class="list-inline mb-0 text-muted">
                          ...
                          <li class="list-inline-item">
                            <i class="mdi mdi-wallet"></i> $380 / hours
                          </li>
                        </ul>
                      </div>
                    </div>
                ...
                <div class="p-4 card-body">
                  <div class="align-items-center row">
                    ...
                    <div class="col-lg-5">
                      <div class="candidate-list-content mt-3 mt-lg-0">
                        <h5 class="fs-19 mb-0">
                          <a class="primary-link" href="#">Betty Richards</a
                          ><span class="badge bg-success ms-1"
                            ><i class="mdi mdi-star align-middle"></i>4.5</span
                          >
                        </h5>
                ...
                <div class="p-4 card-body">
                  <div class="align-items-center row">
                    ...
                    <div class="col-lg-5">
                      <div class="candidate-list-content mt-3 mt-lg-0">
                        <h5 class="fs-19 mb-0">
                          <a class="primary-link" href="#">Jeffrey Montgomery</a
                          ><span class="badge bg-success ms-1"
                            ><i class="mdi mdi-star align-middle"></i>4.9</span
                          >
                        </h5>
                        ...
                        <ul class="list-inline mb-0 text-muted">
                          ...
                          <li class="list-inline-item">
                            <i class="mdi mdi-wallet"></i> $125 / hours
                          </li>
                        </ul>
                      </div>
                    </div>
                ...
                <div class="p-4 card-body">
                  <div class="align-items-center row">
                    ...
                    <div class="col-lg-5">
                      <div class="candidate-list-content mt-3 mt-lg-0">
                        <h5 class="fs-19 mb-0">
                          <a class="primary-link" href="#">Milton Osborn</a
                          ><span class="badge bg-danger ms-1"
                            ><i class="mdi mdi-star align-middle"></i>2.5</span
                          >
                        </h5>
                        ...
                        <ul class="list-inline mb-0 text-muted">
                          ...
                          <li class="list-inline-item">
                            <i class="mdi mdi-wallet"></i> $455 / hours
                          </li>
                        </ul>
                      </div>
                    </div>
                ...
                <div class="p-4 card-body">
                  <div class="align-items-center row">
                    ...
                    <div class="col-lg-5">
                      <div class="candidate-list-content mt-3 mt-lg-0">
                        <h5 class="fs-19 mb-0">
                          <a class="primary-link" href="#">Harold Jordan</a
                          ><span class="badge bg-success ms-1"
                            ><i class="mdi mdi-star align-middle"></i>4.9</span
                          >
                        </h5>
                        ...
                        <ul class="list-inline mb-0 text-muted">
                          ...
                          <li class="list-inline-item">
                            <i class="mdi mdi-wallet"></i> $799 / hours
                          </li>
                        </ul>
                      </div>
                    </div>
                ...
                <div class="p-4 card-body">
                  <div class="align-items-center row">
                    ...
                    <div class="col-lg-5">
                      <div class="candidate-list-content mt-3 mt-lg-0">
                        <h5 class="fs-19 mb-0">
                          <a class="primary-link" href="#">MichaeL Drake </a
                          ><span class="badge bg-warning ms-1"
                            ><i class="mdi mdi-star align-middle"></i>3.9</span
                          >
                        </h5>
                        ...
                        <ul class="list-inline mb-0 text-muted">
                          ...
                          <li class="list-inline-item">
                            <i class="mdi mdi-wallet"></i> $240 / hours
                          </li>
                        </ul>
                      </div>
                    </div>
