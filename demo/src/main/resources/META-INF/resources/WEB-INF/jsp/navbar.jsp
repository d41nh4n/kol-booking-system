...
<head>
  ...
  <title>Navbar</title>
  <link rel="stylesheet" type="text/css" href="../../assert/css/navbar.css">  <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
  ...
  <div class="container-navbar">
    ...
    <c:choose>
      <c:when test="${not empty userInfor}">
        <div class="user-info">
          <a href="/infor">
            <img src="${userInfor.avatar}" alt="user photo">
          </a>
          <div>
