                                    ...
                                    <form id="search-form" method="get" action="/search-page">
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-lg-4 col-md-3 col-sm-12 p-0">
                                                <input type="number" placeholder="Min Price" class="form-control" id="minPrice" name="minPrice">
                                                <input type="number" placeholder="Max Price" class="form-control" id="maxPrice" name="maxPrice">
                                            </div>
                                        </div>
                                        <div class="row mt-2">
                                    ...
                                    <div class="box-product">
                                        ...
                                        <div class="price">
                                            <div class="price-item">
                                                <span class="dot"></span>
                                                <span class="price-down">${user.pricePost}</span> <h6>(A Post)</h6>
                                            </div>
                                            <div class="price-item">
                                                <span class="dot"></span>
                                                <span class="price-down">${user.priceVideo}</span> <h6>(A Video)</h6>
                                            </div>
                                            <div class="price-item">
                                                <span class="dot"></span>
                                                <span class="price-down">${user.priceHireByDay}</span> <h6>(Hire Per Day)</h6>
                                            </div>
                                            <div class="price-item">
                                                <span class="dot"></span>
                                                <span class="price-down">${user.representativePrice}</span> <h6>(Representative)</h6>
                                            </div>
                                        </div>
                                        <div class="rating">
